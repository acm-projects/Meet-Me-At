...
export default function CreateEvent({ route, navigation}) {
    ...
    return (
        <View style={[globalStyles.mainBackground, {paddingTop: 62, paddingHorizontal: 15, flex: 1, alignItems: 'center', marginTop: 15}]}>
                ...
                <Text style={[globalStyles.subTitle, globalStyles.darkText, {fontFamily: "SFProDisplay-Bold", fontSize: 20, alignSelf: 'flex-start', marginTop: 30, marginBottom: 5}]}>Description</Text>
                ...
                <Text style={[globalStyles.subTitle, globalStyles.darkText, {fontFamily: "SFProDisplay-Bold", fontSize: 20, alignSelf: 'flex-start', marginTop: 70, marginBottom: 5}]}>Add Guests</Text>
                <TextInput multiline = {true}
                        numberOfLines = {6}
            ...
            <RoundButton style={{backgroundColor: '#E4E4E4', top: 0}} text="Save Event" onPress={ () => save().then() } />
