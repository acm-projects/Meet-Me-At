function toEventData(host, name, location, time, description, guests) {
    return {host: host, name: name, location: location, time: time, description: description, guests: guests };
}
